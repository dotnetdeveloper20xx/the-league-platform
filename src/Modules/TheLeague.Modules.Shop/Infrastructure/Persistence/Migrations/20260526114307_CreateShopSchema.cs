...
namespace TheLeague.Modules.Shop.Infrastructure.Persistence.Migrations
{
    ...
    public partial class CreateShopSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ClubId_OrderReference",
                schema: "shop",
                table: "Orders",
                columns: new[] { "ClubId", "OrderReference" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestockNotifications_ProductVariantId_MemberId",
                schema: "shop",
                table: "RestockNotifications",
                columns: new[] { "ProductVariantId", "MemberId" },
                unique: true);
        }
